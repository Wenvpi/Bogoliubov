...
\zeta_1(x)= &~{}i \zeta_1(0)\delta(x) \\%  \frac{2\zeta_1'(0)}{\lambda^2}\delta(x) \\% i \zeta_1(0)\delta(x) \\ %\frac{2\zeta_1'(0)}{\lambda^2}\delta(x)
&~{} + f_0(\lambda) \left(  (1-\lambda i)  L_{i \lambda/2}(-2 i x)  +\lambda \, _1F_1\left(1- \frac{\lambda}2 i ;2;-2 i x \right) \right)\\
&~{} + f_0(-\lambda) \left( (1+ \lambda i)L_{-i \lambda/2}(-2 i x) - \lambda \, _1F_1\left(1+  \frac{\lambda}2i ;2;-2 i x \right)\right).
\end{aligned}
\end{equation}
...
\begin{aligned}
\zeta_{1,1}(x)= &~{} f_0(\lambda) \left(  (1-\lambda i)  L_{i \lambda/2}(-2 i x)+  \lambda \, _1F_1\left(1- \frac{\lambda}2 i ;2;-2 i x \right) \right),\\
\zeta_{1,2}(x)=  &~{}  f_0(-\lambda) \left( (1+ \lambda i)L_{-i \lambda/2}(-2 i x) - \lambda \, _1F_1\left(1+  \frac{\lambda}2i ;2;-2 i x \right)\right),
\end{aligned}
\end{equation}
...
and
\begin{equation*}
    \lim_{x\to 0}L_{i\lambda/2}(-2ix)=1,\quad   \lim_{x\to\infty} \Gamma(1+\frac12i\lambda) (2i)^{-i\lambda/2} L_{i\lambda/2}(-2ix) x^{-\frac12i\lambda}=1,\quad \lambda>0\,.
\end{equation*}
